...
//                 <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-3 relative">
//                   <motion.button
//                     whileHover={{ scale: 1.03 }}
//                     type="submit"
//                     disabled={sending}
//                     className="w-full sm:w-auto inline-flex justify-center items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 text-black font-semibold text-sm sm:text-base shadow-md hover:shadow-lg transition disabled:opacity-70 disabled:cursor-not-allowed"
//                   >
//                     {sending ? (
//                       <>
...
//       {/* ✅ Top-center fixed toast (above navbar) */}
//       <AnimatePresence>
//         {toast && (
//           <motion.div
...
//             className={`fixed top-24 left-1/2 -translate-x-1/2 z-[99999] rounded-md px-5 py-3 shadow-lg text-sm font-medium text-center ${
//               toast.type === "success"
//                 ? "bg-emerald-500/95 text-white"
//                 : "bg-rose-500/95 text-white"
//             }`}
...
export default function ContactSection() {
  ...
  function showToast(type, message, duration = 3500) {
    if (toastTimer.current) clearTimeout(toastTimer.current);
    const t = { id: Date.now(), type, msg: message };
    setToast(t);
          ...
          <div className="mx-auto bg-[#02101F]/80 border border-white/6 rounded-2xl p-4 sm:p-6 md:p-8 shadow-[0_18px_60px_rgba(2,10,23,0.6)]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
              ...
              >
                ...
                {/* Buttons + Toast Near Send Button */}
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-3 relative">
                  <div className="flex flex-col gap-2 w-full sm:w-auto">
                    <motion.button
                      ...
                      type="submit"
                      disabled={sending}
                      className="w-full inline-flex justify-center items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 text-black font-semibold text-sm sm:text-base shadow-md hover:shadow-lg transition disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {sending ? (
                        <>
                          <span className="inline-block w-4 h-4 border-2 border-cyan-800 border-t-transparent rounded-full animate-spin"></span>
                    ...
                    <AnimatePresence>
                      {toast && (
                        <motion.div
                          ...
                          className={`inline-flex items-center justify-center px-4 py-2 rounded-full text-sm font-medium shadow-sm ${
                            toast.type === "success"
