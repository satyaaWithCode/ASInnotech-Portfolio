...
//           {/* Mobile Toggle (three dots / X) */}
//           <button
//             onClick={() => setMenuOpen((s) => !s)}
//             aria-label={menuOpen ? "Close menu" : "Open menu"}
//             className="md:hidden text-cyan-400 focus:outline-none p-2 rounded-lg min-w-[44px] flex items-center justify-center z-50"
//           >
...
//       {/* Feedback Modal (rendered at root level of this component tree) */}
...
// /**
//  * FeedbackModal - included inline to keep file self-contained.
//  * - props: open (bool), onClose (fn)
//  * - posts to /api/feedback with { name, email, rating, message }
//  */
...
//                 type="submit"
//                 disabled={sending}
//                 className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 text-black font-semibold text-sm shadow hover:shadow-lg transition"
//               >
